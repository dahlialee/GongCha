...
<body>
    ...
    <div class="container">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="index_home.php?controller=menu&action=quickview&id=<?php echo $item['product_id']; ?>"
        ...
        <a href="index_home.php?controller=menu&action=quickview&id=<?php echo $item['product_id']; ?>" class="btn btn-info">Tiếp tục mua</a>
